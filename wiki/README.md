...
- [Enterprise Linux AI architecture deck](../docs/architecture/agentic-enterprise-linux-reference-architecture-v3.pptx)
  — five editable slides covering the fleet-first model, full SUSE/NVIDIA
  platform, troubleshooting loop, implementation topology, and build gates.
- [Enterprise Linux AI implementation pseudocode](../docs/architecture/enterprise-linux-ai-factory-implementation-pseudocode-v1.docx)
  — phased implementation logic, control contracts, tests, approval objects,
  GitOps promotion, and rollback guidance.
